      ...
      <nav className={styles.navigation} aria-label={t("navigation.mainLabel")}>
          ...
          <div className={styles.account}>
            {!isAppAdmin ? (
              ...
              <div className={styles.adminAccount}>
                <NavLink to={routes.appAdminDashboard}>
                  {t("navigation.admin")}
                </NavLink>
        ...
        <div className={`${styles.drawer} ${open ? styles.drawerOpen : ""}`}>
          <div className={styles.drawerHeading}>
            <Logo className={styles.drawerBrand} />
            <button
              type="button"
              onClick={close}
              aria-label={t("navigation.closeMenu")}
          ...
          <div className={styles.primaryLinks}>
            ...
            <NavLink className={linkClass} to={routes.clubs} onClick={close}>
              {t("navigation.clubs")}
            </NavLink>
            <NavLink className={linkClass} to={routes.games} onClick={close}>
              {t("navigation.games")}
            </NavLink>
            <NavLink
              className={linkClass}
            ...
            <NavLink className={linkClass} to={routes.players} onClick={close}>
              {t("navigation.players")}
            </NavLink>
            {authenticated && !isAppAdmin && (
              <NavLink
                className={linkClass}
                to={routes.myEvents}
                onClick={close}

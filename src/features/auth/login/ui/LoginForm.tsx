    ...
    <section className={styles.formPanel}>
      <div className={styles.formWrap}>
        ...
        <form onSubmit={form.submit} className={styles.form}>
          ...
          {!form.recoveryMode && <label className={styles.terms}><input type="checkbox" checked={form.rememberMe} onChange={(event) => form.setRememberMe(event.target.checked)} /><span>{t("auth.rememberMe")}</span></label>}
